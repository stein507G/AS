...
//#define eepromWrite_Data_Verify(ADDR, SIZE, DATA)			NVM_write(ENVM_HOME_ADJUST_DATA_ADDR, DATA, SIZE, NVM_DO_NOT_LOCK_PAGE)
//#define eepromWrite_Data_Verify_2nd(ADDR, SIZE, DATA)			NVM_write(ENVM_HOME_ADJUST_DATA_ADDR_2nd, DATA, SIZE, NVM_DO_NOT_LOCK_PAGE)
#define nvmWrite_Data_Adjust(ADDR, SIZE, DATA)			NVM_write(ENVM_HOME_ADJUST_DATA_ADDR, DATA, SIZE, NVM_DO_NOT_LOCK_PAGE)
#define nvmWrite_Data_Adjust_2nd(ADDR, SIZE, DATA)			NVM_write(ENVM_HOME_ADJUST_DATA_ADDR_2nd, DATA, SIZE, NVM_DO_NOT_LOCK_PAGE)
#else
