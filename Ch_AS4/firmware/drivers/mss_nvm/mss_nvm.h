...
/*=========================================================================*//**
  ...
  The total amount of eNVM available in a SmartFusion2 device ranges from 128kB
  ...
  SmartFusion2 device and that are not write-protected. The driver imposes no
...
/*******************************************************************************
  ...
  NVM_write() and NVM_unlock() functions.
    ...
    NVM_PAGE_LOCK_WARNING:
      Indicates that the page write operation completed but page was not locked.
      This happens in following situations while writing the page with lock.
      
        - Access of M2S060 - eNVM0 block memory 
        - Access of M2S090/150 - eNVM1 block memory.
        - Access of eNVM memory pages when any protection region in the same
          block (eNVM0 or eNVM1 block) is write protected. 
...
/***************************************************************************//**
  ...
  @return
    This function returns NVM_SUCCESS or NVM_WRITE_THRESHOLD_WARNING or 
    NVM_PAGE_LOCK_WARNING on successful execution. It returns one of the
    following error codes if the programming of the eNVM fails:
...
/***************************************************************************//**
  ...
  @return
    This function returns NVM_SUCCESS or NVM_WRITE_THRESHOLD_WARNING or on successful
