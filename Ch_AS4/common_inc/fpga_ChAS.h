...
#if AS_COOLING_OPTION
#define HeaterPowerOn(X)		{ PELTIER_DATA(((int)(X))<<2);	PELTIER_SET_HEATING;	PELTIER_CON_ON; }
#define HeaterPowerOff()		{ PELTIER_DATA(0);	PELTIER_SET_HEATING;	PELTIER_CON_OFF;}

#define CoolerPowerOn(X)		{ PELTIER_DATA(((int)(X))<<2);	PELTIER_SET_COOLING;	PELTIER_CON_ON;	}
