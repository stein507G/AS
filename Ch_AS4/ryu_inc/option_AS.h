...
// 20220729
// Run이후 다음 분석 시작시 Wakeup - home(X,Y) 찾기 방식 수정 
// 홈찾기 간단하게  
#define RUN_WAIT_HOME_FIND_MODIFY			1
// 20220825
// 2step이하 오류 
// FPGAVer : 11110505 부터 수정됨. 
#define MOVE_STEP_SPEED_ERROR_2_STEP_FIX		1




// 20220803
// Vial 위치 보정 에러 수정 - Vial Plate 각도가 많이 틀어져 있는 경우에 문제 
#define VIAL_XY_CALIBRATION_FIX				1
#define VIAL_XY_CALIBRATION_FIX_Y			1

// 20220823
//#define VIAL_XY_CALIBRATION_FIX_X1			1
//#define VIAL_XY_CALIBRATION_FIX_Y1			1


// step 출력 체크 - 테스트 
#define CHECK_STEP_COUNT		0

// 20220808
#define CHECK_ENCODER_DIRECTION		1

#define MOVE_STEP_SPEED_FUNCTION_CHANGE		1

// initCoordinate() 반올림 오류 
// MICRO_STEP_Y 곱한 후에 반올림 하도록 - 현재는 MICRO_STEP_Y 곱하기 전에 반올림
...
//#define INIT_COORDINATE_FIX					1

#if 1   //Version 5.23

// 20220823 - 
#define READY_CHECK_RETRY_FPGA			1

// 20220824
#define CHECK_AS_INIT_POSITION_ENCODER_TEST		0
	// 	#define AS_INIT_POSITION_ENCODER_TEST		(3)

#define ADJUST_VALUE_LIMIT_25	1

// 20220825
//#define SYRINGE_ENCODER_REMOVE_WASHING

#define CHECK_DIR_MOVING_STATE		1
#endif
...
// 20220901
// 2.5mm 아래로 
// WASH_PORT_DETECT_DEPTH  , POS_Z_WASH_DETECT  , POS_Z_WASH_UPPER_DETECT
// WASTE_PORT_DETECT_DEPTH  , POS_Z_WASH_DETECT  , POS_Z_WASTE_UPPER_DETECT
#define Z_POS_CHECK_WASHPORT_VALUE_MODIFY		1

// INJ_PORT_DETECT_DEPTH  , POS_Z_INJECTION_PORT_DETECT  , POS_Z_INJECTION_PORT_UPPER_DETECT
// 1mm 아래로 
#define Z_POS_CHECK_INJPORT_VALUE_MODIFY		1
