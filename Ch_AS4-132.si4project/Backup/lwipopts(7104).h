...
#define ETHARP_DEBUG							LWIP_DBG_OFF //LWIP_DBG_ON		// LWIP_DBG_OFF
#define TCP_QLEN_DEBUG            LWIP_DBG_OFF // ( LWIP_DBG_ON | LWIP_DBG_LEVEL_WARNING ) 	// LWIP_DBG_OFF //

#define TCP_DEBUG                     LWIP_DBG_ON //  ( LWIP_DBG_ON | LWIP_DBG_LEVEL_WARNING ) 	// LWIP_DBG_OFF
#define TCP_INPUT_DEBUG             LWIP_DBG_OFF //  ( LWIP_DBG_ON | LWIP_DBG_LEVEL_WARNING ) 	// LWIP_DBG_OFF //
...
#define TCP_TMR_INTERVAL       50  /* The TCP timer interval in milliseconds. */ // ryu 20210617
