...
void convert_AdjustData_eeprom2envm()
{
	...
	NVM_write((ENVM_HOME_ADJUST_DATA_ADDR_2nd), &devSet.adjust_2nd.saveFlag, sizeof(devSet.adjust_2nd), NVM_DO_NOT_LOCK_PAGE);
}
...
//		eepromWrite_Data(HOME_ADJUST_DATA_STARTADDR,sizeof(devSet.adjust) + 1,devSet.adjust.saveFlag);		
		NVM_write((ENVM_HOME_ADJUST_DATA_ADDR), &devSet.adjust.saveFlag, (sizeof(devSet.adjust) + 1), NVM_DO_NOT_LOCK_PAGE);		
