...
iprintf("MSS_MAC_phy_autonegotiate()\n");
#endif
...
//iprintf("LocalTime = %d rx p_rx_packet=%d pckt_length=%d \n",LocalTime,cdesc->pkt_start_addr, (cdesc->pkt_size & DMA_DESC_PKT_SIZE_MASK) - 4u);
    } while(0u != rxcnt);
}
