...
#define MAC_ADDR_UVD			0x20u
#define MAC_ADDR_AS 			0x60u
#define MAC_ADDR_OVEN 		0x30u

#define ETHERNET_CONF_ETHADDR0                        0x00u
#define ETHERNET_CONF_ETHADDR1                        MAC_ADDR_OVEN		//0x50u		// AS
...
#define ETHERNET_CONF_IPADDR3                         52
