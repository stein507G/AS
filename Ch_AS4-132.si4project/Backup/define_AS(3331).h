...
//		#define AS_FIRMWARE_VERSION 	520 	// 20211115 추가		

// 20220308
// #define CHROZEN_Z_HEIGHT_SENSOR_MODIFY		1
//		#define FIRMWARE_VERSION		" 5.21" // 맨앞은 space
//		#define MACHINE_VER 	" 5.21"
//		#define AS_FIRMWARE_VERSION 	521 	// 20211115 추가				
...
#define  BASEADDR_MOTOR_Y_SYR				STEPCONTROL18_1
#define  BASEADDR_MOTOR_VAL_INJ 		STEPCONTROL13_0
	#define CMD_CHK_DIR_BASE(WHO) *((uint32_t volatile *)(devSet.baseAddr[WHO] + (0x308 << 2))) = 0x0
*/
//====
	...
	#define CMD_CHK_DIR_STATE_DIR_Z	*((uint32_t volatile *)(devSet.baseAddr[MOTOR_Z] + (0x304 << 2))) = 0x0
//	#define READ_CHK_DIR(WHO) 	*((uint32_t volatile *)(devSet.baseAddr[WHO] + (0x2 << 2)))

// READ_CHK_DIR_Z - bit[1:0]-DIr / bit[5:2]-Pos / bit[7]Break / bit[6] Error
	#define READ_CHK_DIR_Z		*((uint32_t volatile *)(devSet.baseAddr[MOTOR_Z] + (0x2 << 2)))		// 하위 [15:0]
//====
	...
	#define CMD_CHK_DIR_STATE_DIR_X *((uint32_t volatile *)(devSet.baseAddr[MOTOR_X] + (0x305 << 2))) = 0x0

// READ_CHK_DIR_X - bit[17:16]-DIr / bit[21:18]-Pos / bit[23]Break / bit[22] Error
	#define READ_CHK_DIR_X		*((uint32_t volatile *)(devSet.baseAddr[MOTOR_X] + (0x2 << 2)))		// 상위 [31:16]
//====
	...
	#define CMD_CHK_DIR_STATE_DIR_Y	*((uint32_t volatile *)(devSet.baseAddr[MOTOR_Y] + (0x304 << 2))) = 0x0

	#define READ_CHK_DIR_Y		*((uint32_t volatile *)(devSet.baseAddr[MOTOR_Y] + (0x2 << 2)))		// 하위 [15:0]
//====
	...
	#define CMD_CHK_DIR_STATE_DIR_SYR *((uint32_t volatile *)(devSet.baseAddr[MOTOR_SYR] + (0x305 << 2))) = 0x0

	#define READ_CHK_DIR_SYR		*((uint32_t volatile *)(devSet.baseAddr[MOTOR_SYR] + (0x2 << 2)))		// 상위 [31:16]

/*
	#define CMD_CHK_DIR_RESET(WHO) *((uint32_t volatile *)(devSet.baseAddr[WHO] + (0x308 << 2))) = 0x0
