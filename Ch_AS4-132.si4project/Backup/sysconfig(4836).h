...
#define INFO_TEMP_CAL_ENVM_ADDR					0x3F3C0
	#define INFO_TEMP_CAL_ENVM_LEN				12		//20
...
// ==========================================================================================================
	...
	#define USED_TIME_DATA_OFFSET					0x0
	#define HOME_ADJUST_DATA_OFFSET 			0x0

#define ENVM_SYSTEM_CONFIG_DATA_ADDR					(INFO_EEPROM_DATA_ENVM_ADDR + SYSTEM_CONFIG_DATA_OFFSET)
	#define ENVM_SYSTEM_CONFIG_DATA_LEN

#define ENVM_HOME_ADJUST_DATA_ADDR			(INFO_EEPROM_DATA_ENVM_ADDR + HOME_ADJUST_DATA_OFFSET) //0x0			//0x0400		// 36byte
	#define ENVM_HOME_ADJUST_DATA_LEN

#define ENVM_USED_TIME_DATA_ADDR					(INFO_EEPROM_DATA_ENVM_ADDR + USED_TIME_DATA_OFFSET)
	#define ENVM_USED_TIME_DATA_LEN
