...
iprintf("rs422_SendData TSTAT=%x H=%d T=%d data_cnt=%d len=%d nPacketCode=%x\n",TSTAT,tx.Head ,tx.Tail, data_cnt , pPacket->nPacketLength, pPacket->nPacketCode);
