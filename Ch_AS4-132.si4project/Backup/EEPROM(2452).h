...
#define eepromWrite_Data_Verify(ADDR, SIZE, DEST)			NVM_write(ENVM_HOME_ADJUST_DATA_ADDR, DEST, SIZE, NVM_DO_NOT_LOCK_PAGE)
#define eepromWrite_Data_Verify_2nd(ADDR, SIZE, DEST)			NVM_write(ENVM_HOME_ADJUST_DATA_ADDR_2nd, DEST, SIZE, NVM_DO_NOT_LOCK_PAGE)
#else
